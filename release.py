#!/usr/bin/env python
"""A script to publish a release of lakecli to PyPI."""
...
def upload_distribution_files():
    run_step('twine', 'upload', 'dist/*', prompt="Enter your username:")
...
if __name__ == '__main__':
    ...
    ver = version('lakecli/__init__.py')
    print('Releasing Version:', ver)

    if not click.confirm('Are you sure?', default=False):
        sys.exit(1)

    commit_for_release('lakecli/__init__.py', ver)
